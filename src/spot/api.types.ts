...
export interface SpotSpin {
  ...
  listenAccountBalances: (
    ...
    config?: ConfigStatify<AccountBalancesState, AccountBalancesNotify>,
  ) => Subscription;
  /**
  ...
  listenAccountOrders: (
    ...
    config?: ConfigStatify<AccountOrdersState, AccountOrdersNotify>,
  ) => Subscription;
  /**
  ...
  listenAccountTrades: (
    ...
    config?: ConfigNotify<AccountTradesNotify>,
  ) => Subscription;
  /**
   ...
   */
  listenBookL1: (request: ListenBookL1Request, config?: ConfigNotify<BookL1Notify>) => Subscription;
  /**
   ...
   */
  listenBookL2: (request: ListenBookL2Request, config?: ConfigNotify<BookL2Notify>) => Subscription;
  /**
  ...
  listenBookL3: (
    ...
    config?: ConfigStatify<BookL3State, BookL3Notify>,
  ) => Subscription;
  /**
   * Subscribes to the all orders stream of a particular market by it's id
   */
  listenOrders: (request: ListenOrdersRequest, config?: ConfigNotify<OrdersNotify>) => Subscription;
  /**
   * Subscribes to the trades stream of a particular market by it's id
   */
  listenTrades: (request: ListenTradesRequest, config?: ConfigNotify<TradesNotify>) => Subscription;
  /**
   * Bundler
   */
